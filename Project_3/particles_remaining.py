...
# This program will use the no_of_particles.txt file created by
...
# plt.savefig('particles_remaining_nointeraction_finegrain_2nd.pdf')
# plt.savefig('particles_remaining_finegrain_2nd.pdf')
plt.show()
